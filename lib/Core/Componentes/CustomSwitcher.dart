...
class CustomSwitcher extends StatefulWidget {
  ...
  /// This property is required.
  ///
  /// [onChanged] should update the state of the parent [StatefulWidget]
...
class _CustomSwitcherState extends State<CustomSwitcher>
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.value) {
      ...
      _switchColor = widget.activeColor ?? Theme.of(context).primaryColor;
      ...
      _switchColor = widget.inactiveColor ?? Theme.of(context).primaryColor.withOpacity(0.3);
